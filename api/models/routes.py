...
def home():
    Welcome_to_Jeco_API_Endpoints = {
        "User Endpoints": {
            ...
            "GET /users/{user_id}": "Retrieve a specific user by user_id.",
            "POST /users": "Create a new user.",
            "PUT /users/{user_id}": "Update a specific user by user_id.",
            "DELETE /users/{user_id}": "Delete a specific user by user_id.",
        },
        "Orders Endpoints": {
            "GET /orders": "Retrieve a list of orders.",
            "GET /orders/{order_id}": "Retrieve a specific order by order_id.",
            "POST /orders": "Create a new order.",
            "PUT /orders/{order_id}": "Update a specific order by order_id.",
            "DELETE /orders/{order_id}": "Delete a specific order by order_id.",
        },
        "Customers Endpoints": {
        ...
        "Storage Space Endpoints": {
            "GET /storage_spaces": "Retrieve a list of storage spaces.",
            "GET /storage_spaces/{storage_space_id}": "Retrieve a specific storage space by storage_space_id.",
            "POST /storage_spaces": "Create a new storage space.",
            "PUT /storage_spaces/{storage_space_id}": "Update a specific storage space by storage_space_id.",
            "DELETE /storage_spaces/{storage_space_id}": "Delete a specific storage space by storage_space_id.",
        },
        ...
        "Transactions Endpoints": {
            ...
            "PUT /transactions/{transaction_id}": "Update a specific transaction by transaction_id.",
            "DELETE /transactions/{transaction_id}": "Delete a specific transaction by transaction_id.",
        },
        "Files Endpoints": {
